...
# Filter to survey observations in 2004
yr_2004 <- hairy_hermit_sf %>%
  filter(year == 2004 & num_count > 0)

# Map species presence in 2004
tm_shape(california) +
...
# Reflected lollipop chart of abundance by georegion (2004 vs. 2024)
hairy_hermit %>%
